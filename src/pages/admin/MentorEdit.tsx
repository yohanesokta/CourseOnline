...
import { getuserdatamentor } from "../../api/admin.controller"
...
const App = () => {
  ...
  return <div className="p-3 flex flex-col font-poppins md:max-w-md md:p-5">
    {(MentorData) ? <>
      ...
      <div className="xl:bg-white xl:py-4 xl:rounded-2xl xl:w-md xl:shadow-md xl:flex xl:flex-col xl:items-center">
        ...
        <div className="mt-2 xl:mt-4">
          <h3 className="font-semibold xl:text-[14pt]">Nama</h3>
        ...
        <button className="bg-red-500 text-white font-semibold p-2 w-max my-4 rounded">Delete</button>
      </div>
