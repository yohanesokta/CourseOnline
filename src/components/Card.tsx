  ...
  return (
    <div className="w-[250px] relative h-[490px] xl:w-[280px] xl:h-[520px]  border-1 border-gray-300  rounded-2xl overflow-hidden">
        ...
        <div className="px-3 font-poppins">
            ...
            seminggu</h1>
            <p className="font-normal text-sm text-gray-600 xl:text-[12pt] h-[60px] xl:h-[80px] overflow-hidden" style={{textOverflow:"ellipsis"}}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias, eaque? aseasdada</p>
